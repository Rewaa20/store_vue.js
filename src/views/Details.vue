					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img :src="this.$store.state.products[this.$store.state.indToShow].proImg" alt="" />
								<!--<h3>ZOOM</h3>-->
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2>{{this.$store.state.products[this.$store.state.indToShow].proName}}</h2>
								<img src="images/product-details/rating.png" alt="" />
								<span>
									<span> ${{this.$store.state.products[this.$store.state.indToShow].proPrice}}</span>
								...
								<p><b>الصنف:</b> {{this.$store.state.products[this.$store.state.indToShow].proCat}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="details" >
								<div class="col-sm-12">
									<p style="margin-right: 25px;">{{this.$store.state.products[this.$store.state.indToShow].proDes}}</p> 
								</div>
							</div>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<ul>
										...
										<li><a href=""><i class="fa fa-clock-o"></i>{{this.$store.state.products[this.$store.state.indToShow].proDate}}</a></li>
									</ul>
									<p><b>أكتب رأيك</b></p>
									...
									<form action="#">
										...
										<b>التقييم: </b> <img src="images/product-details/rating.png" alt="" />
